module terraform-provider-cloudinit-drive
...
require (
	...
	github.com/vaerh/iso9660 v0.0.0-20231019192018-5dbc9e9c0a55
...
replace github.com/goccy/go-yaml => github.com/vaerh/go-yaml v1.11.1
